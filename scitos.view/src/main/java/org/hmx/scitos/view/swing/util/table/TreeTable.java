...
public class TreeTable extends JXTreeTable {
     ...
     * 
     * @param treeModel
     *            model for this JXTreeTable instance
     */
    public TreeTable(final TreeTableModel treeModel) {
        ...
        this.setLeafIcon(ScitosIcon.CATEGORY.create());
     ...
     *            the maximum column width
     * @param renderer
     *            the (optional) custom renderer to apply for this column (when not in editable state)
     * @param editor
     *            the (optional) custom editor to apply for this column
     * @return the created table column
     */
     ...
     *
     * @param icon
     *            the button's icon to display
     * @param action
     *            the button's associated on-click action
     * @return the created table column
     */
     ...
     *            column that determines the desired row height
     * @param referenceValue
     *            the value to use when calculating the preferred row height
     */
     ...
     * 
     * @param path
     *            designated row's tree path to select
     */
     ...
     * 
     * @param parentPath
     *            path to collect the expanded children for
