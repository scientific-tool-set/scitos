...
public enum AisMessage implements ILocalizableMessage {
    ...
    PROJECT_IMPORT_INTERVIEWS("Ais.Project.Import.Interviews.Ods"),
    PROJECT_IMPORT_INTERVIEWS_INVALID_SPREADSHEET("Ais.Project.Import.Interviews.Ods.InvalidSpreadsheet"),
    PROJECT_IMPORT_INTERVIEWS_SHEET("Ais.Project.Import.Interviews.Ods.SelectSheet"),
    PROJECT_IMPORT_INTERVIEWS_PARTICIPANT_COLUMN("Ais.Project.Import.Interviews.Ods.SelectParticipantColumn"),
    PROJECT_IMPORT_INTERVIEWS_TEXT_COLUMN("Ais.Project.Import.Interviews.Ods.SelectInterviewTextColumn"),
    PROJECT_IMPORT_INTERVIEWS_PREVIEW_SELECT("Ais.Project.Import.Interviews.Ods.Preview.Select"),
    PROJECT_IMPORT_INTERVIEWS_PREVIEW_PARTICIPANT("Ais.Project.Import.Interviews.Ods.Preview.Participant"),
    PROJECT_IMPORT_INTERVIEWS_PREVIEW_TEXT("Ais.Project.Import.Interviews.Ods.Preview.Text"),
